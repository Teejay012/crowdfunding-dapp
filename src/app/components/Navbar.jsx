...
import { Logo, Menu } from "@/app/components/index"
      ...
      <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="relative flex items-center justify-between">
          ...
          {!currentAccount ? (
            <ul className="flex items-center hidden space-x-8 lg:flex">
              <li>
                <button onClick={() => connectWallet()} className='inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none background'>
                  Connect Wallet
                </button>
              </li>
            </ul>
          )
          : <h3 className='text-white font-medium'>Connected As: {`${currentAccount.slice(0, 5)}...${currentAccount.slice(currentAccount.length-5)}`}</h3>
          }
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div>
                      <button
                        ...
                        title="Close Menu"
                        className='p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-grey-200 focus:outtline-none focus:shadow-outline'
